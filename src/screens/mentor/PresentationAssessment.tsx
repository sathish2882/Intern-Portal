...
import { getCategoriesPresentationApi, submitScoreFeedback } from "../../services/mentorApi";
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
                <div>
                  ...
                  <p className="text-xs text-mist mt-0.5">
                    Evaluate intern presentation skills across{" "}
                    {categories.length} categories · Total {maxTotal} points
                  </p>
                </div>
                      ...
                      >
                        ...
                        <div className="px-5 pb-5 border-t border-line pt-4">
                          <Field
                            ...
                            style={{
                              background: `linear-gradient(to right, #d97706 ${(values.category_marks[catIdx]?.marks / cat.totalMarks) * 100}%, #f0f2f5 ${(values.category_marks[catIdx]?.marks / cat.totalMarks) * 100}%)`,
                            }}
                          />
                        </div>
                      </div>
